              ...
              <div className="mt-7">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  <div className="col-span-2 lg:col-span-1">
                    ...
                    <Input type="text" defaultValue={user && user.firstName || ""} />
                  </div>

                  <div className="col-span-2 lg:col-span-1">
                    <Label>Last Name</Label>
                    <Input type="text" defaultValue={user && user.lastName || ""} />
                  </div>

                  <div className="col-span-2 lg:col-span-1">
                    <Label>Email Address</Label>
                    <Input type="text" defaultValue={user && user.emailAddress || ""} />
                  </div>
                  ...
                  <div className="col-span-2">
                    <Label>Bio</Label>
                    <Input type="text" defaultValue="React Developer" />
                  </div>
                </div>
              </div>
            </div>
